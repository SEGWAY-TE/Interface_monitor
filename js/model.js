...
const camera = new THREE.PerspectiveCamera(20, contenedor.clientWidth / contenedor.clientHeight, 5, 150);
...
gltfLoader.load('./models/segway/scene.gltf', (gltfScene) => {
    ...
    gltfScene.scene.position.set(0, 1.1, 0);
...
gltfLoader.load('./models/TrainStation/scene.gltf', (gltfScene) => {
    gltfScene.scene.scale.set(3.5, 3.5, 3.5);
    gltfScene.scene.position.set(15, -4.5, 120);
